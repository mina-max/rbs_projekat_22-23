...
public class PersonRepository {
    ...
    public void delete(int personId) {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            AuditLogger.getAuditLogger(DatabaseAuthenticationProvider.class)
                    .audit("Person with the id '" + personId + "' has been deleted.");
        } catch (SQLException e) {
            LOG.warn("Person deletion failed for personId " + personId, e);
        }
    }
    ...
    public void update(Person personUpdate) {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            LOG.warn("Person update failed for personId " + personUpdate.getId(), e);
        }
    }
}
